...
class UserController extends Controller
{
        ...
        return Datatables::of($data)
                ...
                ->addColumn('action', function($data){
                    ...
                    if (Auth::user()->can('manage_user')){
                        ...
                        <a href="'.url('user/'.$data->id).'" class="btn btn-light-primary font-weight-bold mr-2"><i class="far fa-eye"></i> View</a>

                        <a href="'.url('user/delete/'.$data->id).'" class="btn btn-light-danger font-weight-bold mr-2"><i class="fas fa-trash-alt"></i> Delete</a>
                    </div>';
                    }else{
                        return '';
                    }
    ...
    public function create()
    {
        try
        {
            ...
            $sites = Sites::pluck('site_name','site_id');
            return view('create-user', compact('roles', 'sites'));
